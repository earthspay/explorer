(function () {
	...
	angular.module('web', ['ui.router', 'ui.bootstrap', 'angular-loading-bar', 'angular-growl', 'ngclipboard',
		'vcRecaptcha', 'earths.core.constants', 'earths.core.services']);
})();
(function () {
    'use strict';
...
(function() {
    ...
    angular.module('web').filter('assetunits', function() {
        return function(input, decimals) {
            ...
            var earths = input / Math.pow(10, decimals);
            var str = addCommas(earths.toFixed(decimals));
